...
{
    /// <inheritdoc />
    public partial class init_swipe : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CallRecords_AspNetUsers_CallerId",
                        column: x => x.CallerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CallRecords_AspNetUsers_ReceiverId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShowOnlyOnline = table.Column<bool>(type: "bit", nullable: false),
                    PreferredGender = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ShowVerifiedOnly = table.Column<bool>(type: "bit", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DiscoverySettings_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    BoostStartTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BoostEndTime = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DurationMinutes = table.Column<int>(type: "int", nullable: false),
                    ViewsGenerated = table.Column<int>(type: "int", nullable: false),
                    LikesGenerated = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProfileBoosts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SuperLikes_AspNetUsers_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SuperLikes_AspNetUsers_SenderId",
                        column: x => x.SenderId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SwiperId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    SwipedUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Swipe_AspNetUsers_SwipedUserId",
                        column: x => x.SwipedUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Swipe_AspNetUsers_SwiperId",
                        column: x => x.SwiperId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CallRecords_ReceiverId",
                table: "CallRecords",
                column: "ReceiverId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Likes_LikerId_LikedUserId",
                table: "Likes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SuperLikes_ReceiverId",
                table: "SuperLikes",
                column: "ReceiverId");

            migrationBuilder.CreateIndex(
                name: "IX_SuperLikes_SenderId",
                table: "SuperLikes",
                column: "SenderId");

            migrationBuilder.CreateIndex(
                name: "IX_Swipe_SwipedUserId",
                table: "Swipe",
                column: "SwipedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Swipe_SwiperId",
                table: "Swipe",
                column: "SwiperId");
