...
namespace webchat.Migrations
{
    ...
    [Migration("20250629202654_confix_Filter")]
    partial class confix_Filter
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("webchat.Models.DiscoverySettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("ShowOnlyOnline")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("webchat.Models.ProfileBoost", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webchat.Models.SuperLike", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webchat.Models.Swipe", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("webchat.Models.Swipe", b =>
                {
                    b.HasOne("webchat.Models.ApplicationUser", "SwipedUser")
                        .WithMany()
                        .HasForeignKey("SwipedUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("webchat.Models.ApplicationUser", "Swiper")
                        .WithMany()
